    ...
    if (isMobile) {
        ...
        container.innerHTML = `
            <a href="./pages/categories.html">
                <img src="/MICRO-SITE-TEC/src/assets/logo-tec/landing-1-portada.png" alt="TEC">
            </a>
        `;
    } else {
        // Si es un dispositivo de escritorio, mostrar la imagen estática del QR
        container.innerHTML = `
            <img src="/MICRO-SITE-TEC/src/assets/logo-tec/img-qr-code.jpeg" alt="Escanea este código QR para acceder desde tu celular" 
